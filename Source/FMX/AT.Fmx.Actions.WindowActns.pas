unit AT.Fmx.Actions.WindowActns;
...
type
  ...
  TATWindowClose = class(TWindowClose)
  strict private
...
constructor TATWindowClose.Create(AOwner: TComponent);
begin
...
procedure TATWindowClose.Loaded;
begin
  inherited Loaded;
...
procedure TATWindowClose.SetAndroidImageIndex(const Value: TImageIndex);
begin
...
procedure TATWindowClose.SetAndroidText(const Value: String);
begin
...
procedure TATWindowClose.SetiOSImageIndex(const Value: TImageIndex);
begin
...
procedure TATWindowClose.SetiOSText(const Value: String);
begin
...
procedure TATWindowClose.SetLinuxHint(const Value: String);
begin
...
procedure TATWindowClose.SetLinuxImageIndex(const Value: TImageIndex);
begin
...
procedure TATWindowClose.SetLinuxShortCut(Value: System.Classes.TShortCut);
begin
...
procedure TATWindowClose.SetLinuxText(const Value: String);
begin
...
procedure TATWindowClose.SetOSXHint(const Value: String);
begin
...
procedure TATWindowClose.SetOSXImageIndex(const Value: TImageIndex);
begin
...
procedure TATWindowClose.SetOSXShortCut(Value: System.Classes.TShortCut);
begin
...
procedure TATWindowClose.SetOSXText(const Value: String);
begin
...
procedure TATWindowClose.SetWindowsHint(const Value: String);
begin
...
procedure TATWindowClose.SetWindowsImageIndex(const Value: TImageIndex);
begin
...
procedure TATWindowClose.SetWindowsShortCut(Value:
...
procedure TATWindowClose.SetWindowsText(const Value: String);
begin
...
function TATWindowClose._AndroidImgIdxIsStored: Boolean;
begin
  Result := (FAndroidImageIndex <> -1);
end;

function TATWindowClose._AndroidTextIsStored: Boolean;
begin
  Result := (NOT FAndroidText.IsEmpty);
end;

function TATWindowClose._iOSImgIdxIsStored: Boolean;
begin
  Result := (FiOSImageIndex <> -1);
end;

function TATWindowClose._iOSTextIsStored: Boolean;
begin
  Result := (NOT FiOSText.IsEmpty);
end;

function TATWindowClose._LinuxHintIsStored: Boolean;
begin
  Result := (NOT FLinuxHint.IsEmpty);
end;

function TATWindowClose._LinuxImgIdxIsStored: Boolean;
begin
  Result := (FLinuxImageIndex <> -1);
end;

function TATWindowClose._LinuxShortCutIsStored: Boolean;
begin
  Result := (FLinuxShortCut <> 0);
end;

function TATWindowClose._LinuxTextIsStored: Boolean;
begin
  Result := (NOT FLinuxText.IsEmpty);
end;

function TATWindowClose._OSXHintIsStored: Boolean;
begin
  Result := (NOT FOSXHint.IsEmpty);
end;

function TATWindowClose._OSXImgIdxIsStored: Boolean;
begin
  Result := (FOSXImageIndex <> -1);
end;

function TATWindowClose._OSXShortCutIsStored: Boolean;
begin
  Result := (FOSXShortCut <> 0);
end;

function TATWindowClose._OSXTextIsStored: Boolean;
begin
  Result := (NOT FOSXText.IsEmpty);
end;

function TATWindowClose._WinHintIsStored: Boolean;
begin
  Result := (NOT FWindowsHint.IsEmpty);
end;

function TATWindowClose._WinImgIdxIsStored: Boolean;
begin
  Result := (FWindowsImageIndex <> -1);
end;

function TATWindowClose._WinShortCutIsStored: Boolean;
begin
  Result := (FWindowsShortCut <> 0);
end;

function TATWindowClose._WinTextIsStored: Boolean;
begin

unit AT.Fmx.Actions.Base;

interface

uses
  System.Classes, System.UITypes, Fmx.ActnList, AT.Fmx.Actions.Consts;

type
  [ComponentPlatformsAttribute(pidATActionsPlatforms)]
  TATAction = class(TAction)
  strict private
...
constructor TATAction.Create(AOwner: TComponent);
begin
...
procedure TATAction.SetAndroidImageIndex(const Value: TImageIndex);
begin
...
procedure TATAction.SetAndroidText(const Value: String);
begin
...
procedure TATAction.SetiOSImageIndex(const Value: TImageIndex);
begin
...
procedure TATAction.SetiOSText(const Value: String);
begin
...
procedure TATAction.SetLinuxHint(const Value: String);
begin
...
procedure TATAction.SetLinuxImageIndex(const Value: TImageIndex);
begin
...
procedure TATAction.SetLinuxShortCut(Value: System.Classes.TShortCut);
begin
...
procedure TATAction.SetLinuxText(const Value: String);
begin
...
procedure TATAction.SetOSXHint(const Value: String);
begin
...
procedure TATAction.SetOSXImageIndex(const Value: TImageIndex);
begin
...
procedure TATAction.SetOSXShortCut(Value: System.Classes.TShortCut);
begin
...
procedure TATAction.SetOSXText(const Value: String);
begin
...
procedure TATAction.SetWindowsHint(const Value: String);
begin
...
procedure TATAction.SetWindowsImageIndex(const Value: TImageIndex);
begin
...
procedure TATAction.SetWindowsShortCut(Value:
...
procedure TATAction.SetWindowsText(const Value: String);
begin
...
function TATAction._AndroidImgIdxIsStored: Boolean;
begin
  Result := (FAndroidImageIndex <> -1);
end;

function TATAction._AndroidTextIsStored: Boolean;
begin
  Result := (NOT FAndroidText.IsEmpty);
end;

function TATAction._iOSImgIdxIsStored: Boolean;
begin
  Result := (FiOSImageIndex <> -1);
end;

function TATAction._iOSTextIsStored: Boolean;
begin
  Result := (NOT FiOSText.IsEmpty);
end;

function TATAction._LinuxHintIsStored: Boolean;
begin
  Result := (NOT FLinuxHint.IsEmpty);
end;

function TATAction._LinuxImgIdxIsStored: Boolean;
begin
  Result := (FLinuxImageIndex <> -1);
end;

function TATAction._LinuxShortCutIsStored: Boolean;
begin
  Result := (FLinuxShortCut <> 0);
end;

function TATAction._LinuxTextIsStored: Boolean;
begin
  Result := (NOT FLinuxText.IsEmpty);
end;

function TATAction._OSXHintIsStored: Boolean;
begin
  Result := (NOT FOSXHint.IsEmpty);
end;

function TATAction._OSXImgIdxIsStored: Boolean;
begin
  Result := (FOSXImageIndex <> -1);
end;

function TATAction._OSXShortCutIsStored: Boolean;
begin
  Result := (FOSXShortCut <> 0);
end;

function TATAction._OSXTextIsStored: Boolean;
begin
  Result := (NOT FOSXText.IsEmpty);
end;

function TATAction._WinHintIsStored: Boolean;
begin
  Result := (NOT FWindowsHint.IsEmpty);
end;

function TATAction._WinImgIdxIsStored: Boolean;
begin
  Result := (FWindowsImageIndex <> -1);
end;

function TATAction._WinShortCutIsStored: Boolean;
begin
  Result := (FWindowsShortCut <> 0);
end;

function TATAction._WinTextIsStored: Boolean;
begin

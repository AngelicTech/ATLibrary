unit AT.Fmx.Actions.ValueRange;
...
type
  ...
  TATValueRangeAction = class(TValueRangeAction)
  strict private
...
constructor TATValueRangeAction.Create(AOwner: TComponent);
begin
...
procedure TATValueRangeAction.Loaded;
begin
  inherited Loaded;
...
procedure TATValueRangeAction.SetAndroidImageIndex(const Value: TImageIndex);
begin
...
procedure TATValueRangeAction.SetAndroidText(const Value: String);
begin
...
procedure TATValueRangeAction.SetiOSImageIndex(const Value: TImageIndex);
begin
...
procedure TATValueRangeAction.SetiOSText(const Value: String);
begin
...
procedure TATValueRangeAction.SetLinuxHint(const Value: String);
begin
...
procedure TATValueRangeAction.SetLinuxImageIndex(const Value: TImageIndex);
begin
...
procedure TATValueRangeAction.SetLinuxShortCut(Value: System.Classes.TShortCut);
begin
...
procedure TATValueRangeAction.SetLinuxText(const Value: String);
begin
...
procedure TATValueRangeAction.SetOSXHint(const Value: String);
begin
...
procedure TATValueRangeAction.SetOSXImageIndex(const Value: TImageIndex);
begin
...
procedure TATValueRangeAction.SetOSXShortCut(Value: System.Classes.TShortCut);
begin
...
procedure TATValueRangeAction.SetOSXText(const Value: String);
begin
...
procedure TATValueRangeAction.SetWindowsHint(const Value: String);
begin
...
procedure TATValueRangeAction.SetWindowsImageIndex(const Value: TImageIndex);
begin
...
procedure TATValueRangeAction.SetWindowsShortCut(Value:
...
procedure TATValueRangeAction.SetWindowsText(const Value: String);
begin
...
function TATValueRangeAction._AndroidImgIdxIsStored: Boolean;
begin
  Result := (FAndroidImageIndex <> -1);
end;

function TATValueRangeAction._AndroidTextIsStored: Boolean;
begin
  Result := (NOT FAndroidText.IsEmpty);
end;

function TATValueRangeAction._iOSImgIdxIsStored: Boolean;
begin
  Result := (FiOSImageIndex <> -1);
end;

function TATValueRangeAction._iOSTextIsStored: Boolean;
begin
  Result := (NOT FiOSText.IsEmpty);
end;

function TATValueRangeAction._LinuxHintIsStored: Boolean;
begin
  Result := (NOT FLinuxHint.IsEmpty);
end;

function TATValueRangeAction._LinuxImgIdxIsStored: Boolean;
begin
  Result := (FLinuxImageIndex <> -1);
end;

function TATValueRangeAction._LinuxShortCutIsStored: Boolean;
begin
  Result := (FLinuxShortCut <> 0);
end;

function TATValueRangeAction._LinuxTextIsStored: Boolean;
begin
  Result := (NOT FLinuxText.IsEmpty);
end;

function TATValueRangeAction._OSXHintIsStored: Boolean;
begin
  Result := (NOT FOSXHint.IsEmpty);
end;

function TATValueRangeAction._OSXImgIdxIsStored: Boolean;
begin
  Result := (FOSXImageIndex <> -1);
end;

function TATValueRangeAction._OSXShortCutIsStored: Boolean;
begin
  Result := (FOSXShortCut <> 0);
end;

function TATValueRangeAction._OSXTextIsStored: Boolean;
begin
  Result := (NOT FOSXText.IsEmpty);
end;

function TATValueRangeAction._WinHintIsStored: Boolean;
begin
  Result := (NOT FWindowsHint.IsEmpty);
end;

function TATValueRangeAction._WinImgIdxIsStored: Boolean;
begin
  Result := (FWindowsImageIndex <> -1);
end;

function TATValueRangeAction._WinShortCutIsStored: Boolean;
begin
  Result := (FWindowsShortCut <> 0);
end;

function TATValueRangeAction._WinTextIsStored: Boolean;
begin

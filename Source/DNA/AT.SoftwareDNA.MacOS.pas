...
// Framework      : None
//
// Filename       : AT.SoftwareDNA.MacOS.pas
// File Version   : 1.00
...
// Description:
//
// Software DNA Interface for Mac OS X
//
// Revision History:
//
...
// NOTE: See AT.SoftwareDNA.XPlatform for documentation...

unit AT.SoftwareDNA.MacOS;
...
uses
  ...
  AT.DNA.FMX.Dlg.ActivationCode, System.UITypes, FMX.Forms,
  AT.DNA.FMX.Dlg.RequestEval, System.Math, System.DateUtils,
  AT.DNA.FMX.Dlg.ValidationWarning, AT.DNA.FMX.Dlg.ProxySettings,
  FMX.Dialogs, AT.DNA.FMX.Dlg.Activation, AT.DNA.FMX.Dlg.Reactivation,
  AT.DNA.FMX.Dlg.ReactivationMU, AT.DNA.FMX.Dlg.ForgotPwd;

type
  TDNA_ActivateFunc = function(ProductKey, ActivationCode, Password,
    Email: PAnsiChar): Integer; cdecl;
  ...
  TDNA_ErrorFunc = function(ErrorNo: Integer; Msg: PAnsiChar;
    MsgSize: Integer): Integer; cdecl;
  TDNA_EvalNowFunc = function(ProductKey: PAnsiChar): Integer; cdecl;
  TDNA_InfoTagFunc = function(ProductKey, ActivationCode,
    Tag: PAnsiChar): Integer; cdecl;
  TDNA_ParamFunc = function(Param, Value: PAnsiChar;
    ValueSize: Integer): Integer; cdecl;
  TDNA_QueryFunc = function(ProductKey, ActivationCode: PAnsiChar)
    : Integer; cdecl;
  TDNA_ReactivateFunc = function(ProductKey, ActivationCode,
    OldPassword, NewPassword: PAnsiChar): Integer; cdecl;
  TDNA_SendEvalCodeFunc = function(ProductKey, Email: PAnsiChar;
    UseMachineID: Integer): Integer cdecl;
  TDNA_SendPwdFunc = function(ProductKey, ActivationCode: PAnsiChar)
    : Integer; cdecl;
  TDNA_SetBuildNoFunc = function(BuildNo: PAnsiChar): Integer; cdecl;
  TDNA_SetPathNameFunc = function(PathName: PAnsiChar)
    : Integer; cdecl;
  TDNA_SetLangFunc = function(Language: Integer): Integer; cdecl;
  TDNA_SetProxyFunc = function(Server, Port, UserName,
    Password: PAnsiChar): Integer; cdecl;
  TDNA_UseIEFunc = function(UseIESettings: Integer): Integer; cdecl;
  TDNA_ValidateFunc = function(ProductKey: PAnsiChar): Integer; cdecl;
...
function DNAProtectionOK(Key: String;
    RequestEvalCode, UseMachineID: Boolean;
    out Error: Integer): Boolean;
var
  ACode: String;
begin

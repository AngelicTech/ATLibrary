unit AT.DNA.VCL.Dlg.EvalWarning;
...
uses
  ...
  cxButtons, dxBevel, AT.SoftwareDNA.Types, System.Win.TaskbarCore,
  Vcl.Taskbar, dxTaskbarProgress;

type
  TDNAEvalWarnDlg = class(TDNABaseDlg)
    btnActivatePurchase: TcxButton;
    btnBuyNow: TcxButton;
    lblEvalMsg: TcxLabel;

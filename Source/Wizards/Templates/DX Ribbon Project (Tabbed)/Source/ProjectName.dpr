...
uses
  ...
  AT.ShortName.DX.TabFormChild in 'Code Files\AT.ShortName.DX.TabFormChild.pas',
  AT.ShortName.DX.TabFrameChild in 'Code Files\AT.ShortName.DX.TabFrameChild.pas',
  ...
  AT.ShortName.Vcl.Forms.Generic.TabForm in 'Forms\AT.ShortName.Vcl.Forms.Generic.TabForm.pas' {frmGenericTabForm},
  AT.ShortName.Vcl.Forms.Generic.TabRibbon in 'Forms\AT.ShortName.Vcl.Forms.Generic.TabRibbon.pas' {frmTabRibbonForm},
  AT.ShortName.Vcl.Frames.Generic.Base in 'Frames\AT.ShortName.Vcl.Frames.Generic.Base.pas' {fraGenericBase: TFrame},
  AT.ShortName.Vcl.Frames.Generic.Tab in 'Frames\AT.ShortName.Vcl.Frames.Generic.Tab.pas' {fraGenericTab: TFrame},
...
begin
  ...
  TdlgSplashDX.ChangeStartMessage(rstrStartInit, cStartMsgDelay);
